...
--
-- Chaque famille a un fallback "{Famille} · Autre" (nom unique par famille, pas juste "Autre").
--
-- Collision avec une catégorie déjà existante (ex. l'utilisateur a déjà "Transport", et la
-- taxonomie a aussi une famille "Transport") : on ne crée PAS de doublon — la catégorie déjà
-- existante est réutilisée comme parent pour les nouvelles sous-catégories de cette famille,
-- et une sous-catégorie déjà existante sous ce nom est simplement laissée telle quelle, sans la
-- retoucher (pour ne jamais changer silencieusement une catégorie déjà utilisée par de vraies
-- transactions).
--
-- Sûr à relancer : un utilisateur qui a déjà au moins une catégorie avec un tier renseigné est
-- considéré comme déjà ensemencé et n'est pas retraité.
...
as $func$
declare
  taxonomy jsonb := '[{"label": "Abonnements", "tier": "amateur", "icon": "Credit card/Color/credit_card_color.svg", "subcategories": [{"label": "Streaming", "tier": "amateur", "icon": "Clapper board/Color/clapper_board_color.svg", "is_fallback": false}, {"label": "Logiciels / Cloud", "tier": "amateur", "icon": "Laptop/Color/laptop_color.svg", "is_fallback": false}, {"label": "Salle de sport / Bien-être", "tier": "amateur", "icon": "Person lifting weights/Default/Color/person_lifting_weights_color_default.svg", "is_fallback": false}, {"label": "Abonnements · Autre", "tier": "amateur", "icon": null, "is_fallback": true}]}, {"label": "Alimentation", "tier": "amateur", "icon": "Fork and knife with plate/Color/fork_and_knife_with_plate_color.svg", "subcategories": [{"label": "Courses", "tier": "amateur", "icon": "Shopping cart/Color/shopping_cart_color.svg", "is_fallback": false}, {"label": "Restaurants", "tier": "amateur", "icon": "Fork and knife with plate/Color/fork_and_knife_with_plate_color.svg", "is_fallback": false}, {"label": "Fast-food / Livraison", "tier": "amateur", "icon": "Pizza/Color/pizza_color.svg", "is_fallback": false}, {"label": "Boulangerie", "tier": "confirme", "icon": "Bread/Color/bread_color.svg", "is_fallback": false}, {"label": "Café", "tier": "confirme", "icon": "Hot beverage/Color/hot_beverage_color.svg", "is_fallback": false}, {"label": "Alimentation · Autre", "tier": "amateur", "icon": null, "is_fallback": true}]}, {"label": "Logement", "tier": "amateur", "icon": "House/Color/house_color.svg", "subcategories": [{"label": "Loyer / Crédit immobilier", "tier": "amateur", "icon": "House with garden/Color/house_with_garden_color.svg", "is_fallback": false}, {"label": "Charges (eau, élec, gaz)", "tier": "amateur", "icon": "Electric plug/Color/electric_plug_color.svg", "is_fallback": false}, {"label": "Internet / Téléphone", "tier": "amateur", "icon": "Globe with meridians/Color/globe_with_meridians_color.svg", "is_fallback": false}, {"label": "Assurance habitation", "tier": "confirme", "icon": "Shield/Color/shield_color.svg", "is_fallback": false}, {"label": "Entretien / Bricolage", "tier": "confirme", "icon": "Hammer and wrench/Color/hammer_and_wrench_color.svg", "is_fallback": false}, {"label": "Mobilier / Décoration", "tier": "confirme", "icon": "Couch and lamp/Color/couch_and_lamp_color.svg", "is_fallback": false}, {"label": "Logement · Autre", "tier": "amateur", "icon": null, "is_fallback": true}]}, {"label": "Transport", "tier": "amateur", "icon": "Automobile/Color/automobile_color.svg", "subcategories": [{"label": "Essence / Carburant", "tier": "amateur", "icon": "Fuel pump/Color/fuel_pump_color.svg", "is_fallback": false}, {"label": "Transports en commun", "tier": "amateur", "icon": "Bus/Color/bus_color.svg", "is_fallback": false}, {"label": "Assurance auto / moto", "tier": "amateur", "icon": "Shield/Color/shield_color.svg", "is_fallback": false}, {"label": "Entretien véhicule", "tier": "confirme", "icon": "Wrench/Color/wrench_color.svg", "is_fallback": false}, {"label": "Parking / Péage", "tier": "confirme", "icon": "Automobile/Color/automobile_color.svg", "is_fallback": false}, {"label": "Vélo / Trottinette", "tier": "confirme", "icon": "Bicycle/Color/bicycle_color.svg", "is_fallback": false}, {"label": "Transport · Autre", "tier": "amateur", "icon": null, "is_fallback": true}]}, {"label": "Santé", "tier": "amateur", "icon": "Hospital/Color/hospital_color.svg", "subcategories": [{"label": "Pharmacie", "tier": "amateur", "icon": "Pill/Color/pill_color.svg", "is_fallback": false}, {"label": "Médecin / Consultations", "tier": "amateur", "icon": "Stethoscope/Color/stethoscope_color.svg", "is_fallback": false}, {"label": "Mutuelle / Assurance santé", "tier": "confirme", "icon": "Shield/Color/shield_color.svg", "is_fallback": false}, {"label": "Sport / Salle de sport", "tier": "amateur", "icon": "Person lifting weights/Default/Color/person_lifting_weights_color_default.svg", "is_fallback": false}, {"label": "Bien-être (spa, méditation)", "tier": "confirme", "icon": "Person in lotus position/Default/Color/person_in_lotus_position_color_default.svg", "is_fallback": false}, {"label": "Santé · Autre", "tier": "amateur", "icon": null, "is_fallback": true}]}, {"label": "Shopping", "tier": "amateur", "icon": "Shopping bags/Color/shopping_bags_color.svg", "subcategories": [{"label": "Vêtements", "tier": "amateur", "icon": "T-shirt/Color/t-shirt_color.svg", "is_fallback": false}, {"label": "Électronique / High-tech", "tier": "amateur", "icon": "Laptop/Color/laptop_color.svg", "is_fallback": false}, {"label": "Beauté / Cosmétique", "tier": "amateur", "icon": "Lipstick/Color/lipstick_color.svg", "is_fallback": false}, {"label": "Cadeaux", "tier": "amateur", "icon": "Wrapped gift/Color/wrapped_gift_color.svg", "is_fallback": false}, {"label": "Maison / Équipement", "tier": "confirme", "icon": "Couch and lamp/Color/couch_and_lamp_color.svg", "is_fallback": false}, {"label": "Shopping · Autre", "tier": "amateur", "icon": null, "is_fallback": true}]}, {"label": "Loisirs", "tier": "amateur", "icon": "Video game/Color/video_game_color.svg", "subcategories": [{"label": "Abonnements streaming", "tier": "amateur", "icon": "Clapper board/Color/clapper_board_color.svg", "is_fallback": false}, {"label": "Sorties / Bars", "tier": "amateur", "icon": "Cocktail glass/Color/cocktail_glass_color.svg", "is_fallback": false}, {"label": "Cinéma / Concerts", "tier": "confirme", "icon": "Ticket/Color/ticket_color.svg", "is_fallback": false}, {"label": "Jeux vidéo", "tier": "confirme", "icon": "Video game/Color/video_game_color.svg", "is_fallback": false}, {"label": "Livres / Presse", "tier": "confirme", "icon": "Open book/Color/open_book_color.svg", "is_fallback": false}, {"label": "Hobbies", "tier": "confirme", "icon": "Artist palette/Color/artist_palette_color.svg", "is_fallback": false}, {"label": "Loisirs · Autre", "tier": "amateur", "icon": null, "is_fallback": true}]}, {"label": "Voyages", "tier": "amateur", "icon": "Airplane/Color/airplane_color.svg", "subcategories": [{"label": "Billets (avion, train)", "tier": "amateur", "icon": "Airplane departure/Color/airplane_departure_color.svg", "is_fallback": false}, {"label": "Hébergement", "tier": "amateur", "icon": "Bed/Color/bed_color.svg", "is_fallback": false}, {"label": "Location de véhicule", "tier": "confirme", "icon": "Automobile/Color/automobile_color.svg", "is_fallback": false}, {"label": "Activités sur place", "tier": "confirme", "icon": "Beach with umbrella/Color/beach_with_umbrella_color.svg", "is_fallback": false}, {"label": "Voyages · Autre", "tier": "amateur", "icon": null, "is_fallback": true}]}, {"label": "Travail / Pro", "tier": "amateur", "icon": "Briefcase/Color/briefcase_color.svg", "subcategories": [{"label": "Matériel professionnel", "tier": "confirme", "icon": "Laptop/Color/laptop_color.svg", "is_fallback": false}, {"label": "Formation / Cours", "tier": "confirme", "icon": "Graduation cap/Color/graduation_cap_color.svg", "is_fallback": false}, {"label": "Déplacements pro", "tier": "confirme", "icon": "Airplane departure/Color/airplane_departure_color.svg", "is_fallback": false}, {"label": "Repas pro", "tier": "confirme", "icon": "Fork and knife with plate/Color/fork_and_knife_with_plate_color.svg", "is_fallback": false}, {"label": "Travail / Pro · Autre", "tier": "amateur", "icon": null, "is_fallback": true}]}, {"label": "Finances / Admin", "tier": "amateur", "icon": "Money bag/Color/money_bag_color.svg", "subcategories": [{"label": "Impôts", "tier": "amateur", "icon": "Receipt/Color/receipt_color.svg", "is_fallback": false}, {"label": "Frais bancaires", "tier": "confirme", "icon": "Credit card/Color/credit_card_color.svg", "is_fallback": false}, {"label": "Assurances (autres)", "tier": "confirme", "icon": "Shield/Color/shield_color.svg", "is_fallback": false}, {"label": "Épargne", "tier": "amateur", "icon": "Money with wings/Color/money_with_wings_color.svg", "is_fallback": false}, {"label": "Investissement", "tier": "investisseur", "icon": "Chart increasing/Color/chart_increasing_color.svg", "is_fallback": false}, {"label": "Remboursement de prêt", "tier": "amateur", "icon": "Money bag/Color/money_bag_color.svg", "is_fallback": false}, {"label": "Dons / Charité", "tier": "confirme", "icon": "Heart hands/Default/Color/heart_hands_color_default.svg", "is_fallback": false}, {"label": "Finances / Admin · Autre", "tier": "amateur", "icon": null, "is_fallback": true}]}, {"label": "Famille", "tier": "amateur", "icon": "People hugging/Color/people_hugging_color.svg", "subcategories": [{"label": "Garde d''enfants", "tier": "confirme", "icon": "Baby/Default/Color/baby_color_default.svg", "is_fallback": false}, {"label": "Scolarité", "tier": "confirme", "icon": "Graduation cap/Color/graduation_cap_color.svg", "is_fallback": false}, {"label": "Enfants / Jouets", "tier": "confirme", "icon": "Teddy bear/Color/teddy_bear_color.svg", "is_fallback": false}, {"label": "Animaux de compagnie", "tier": "confirme", "icon": "Dog/Color/dog_color.svg", "is_fallback": false}, {"label": "Famille · Autre", "tier": "amateur", "icon": null, "is_fallback": true}]}, {"label": "Revenus", "tier": "amateur", "icon": "Money with wings/Color/money_with_wings_color.svg", "subcategories": [{"label": "Salaire", "tier": "amateur", "icon": "Money bag/Color/money_bag_color.svg", "is_fallback": false}, {"label": "Freelance / Indépendant", "tier": "amateur", "icon": "Briefcase/Color/briefcase_color.svg", "is_fallback": false}, {"label": "Remboursements", "tier": "amateur", "icon": "Money with wings/Color/money_with_wings_color.svg", "is_fallback": false}, {"label": "Cadeaux reçus", "tier": "confirme", "icon": "Wrapped gift/Color/wrapped_gift_color.svg", "is_fallback": false}, {"label": "Ventes (seconde main)", "tier": "confirme", "icon": "Shopping bags/Color/shopping_bags_color.svg", "is_fallback": false}, {"label": "Dividendes / Intérêts", "tier": "investisseur", "icon": "Chart increasing/Color/chart_increasing_color.svg", "is_fallback": false}, {"label": "Aides / Bourses", "tier": "confirme", "icon": "Graduation cap/Color/graduation_cap_color.svg", "is_fallback": false}, {"label": "Revenus · Autre", "tier": "amateur", "icon": null, "is_fallback": true}]}]'::jsonb;
  cat jsonb;
  sub jsonb;
  new_parent_id uuid;
  existing_id uuid;
begin
  for cat in select * from jsonb_array_elements(taxonomy) loop
    select id into existing_id from categories
      where user_id = target_user and lower(name) = lower(cat->>'label')
      limit 1;
    ...
    for sub in select * from jsonb_array_elements(cat->'subcategories') loop
      select id into existing_id from categories
        where user_id = target_user and lower(name) = lower(sub->>'label')
        limit 1;
...
-- Applique la taxonomie à tous les comptes déjà existants qui ne l'ont pas encore reçue.
do $$
declare
  u record;
begin
  for u in
    ...
    where id not in (select user_id from categories where tier is not null)
  loop
